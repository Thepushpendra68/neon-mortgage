...
export default function PurchaseStep3() {
  ...
  useEffect(() => {
    ...
    if (!savedLoanType || savedLoanType !== 'new-purchase' || !savedResidencyStatus || !savedPropertyStatus) {
  ...
  const handleOptionSelect = (optionId) => {
    ...
    setTimeout(() => {
      ...
      router.push('/get-mortgage/purchase/step4');
    }, 300);
  };
  ...
  return (
    <div className="min-h-screen page-enter" style={{ background: 'var(--pure-white)' }}>
      ...
      <div className="trust-banner">
        🏢 All Property Types • Villas, apartments, townhouses supported
      </div>
      ...
      {/* Back Button */}
      <button
        onClick={() => router.push('/get-mortgage/purchase/step2')}
        className="btn-back"
      >
        ← Back
      </button>
